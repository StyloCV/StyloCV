...
class Basics(BaseModel):
    ...
    class Location(BaseModel):
        """Location sub-section in the basics section.
    ...
    class Profiles(BaseModel):
        """Profiles sub-section in the basics section.
...
class Volunteer(BaseModel):
    """Volunteer section in the resume.
...
class Certificate(BaseModel):
    """Certificate section in the resume.
...
class Publication(BaseModel):
    """Publication section in the resume.
...
class Language(BaseModel):
    """Language section in the resume.
...
class Interest(BaseModel):
    """Interest section in the resume.
...
class Reference(BaseModel):
    """Reference section in the resume.
...
class Meta(BaseModel):
    """Meta information about the resume.
...
class CustomSection(BaseModel):
    """A custom section in the resume.
    ...
    class Highlight(BaseModel):
        """A highlight in the custom section.
...
class Resume(BaseModel):
    """A CV/Resume model following the cv-model specification.
    ...
    json_schema: str = Field(
        default=f"https://raw.githubusercontent.com/austinyu/cv-model/refs/heads/main/schemas/{_consts.RESUME_SCHEMA_NAME}",
        alias="$schema",
    )
    basics: Basics = Field(
    ...
    def load(src: str) -> Resume:
        ...
        Args:
            src: A string containing the resume data in JSON format.
        ...
        if parsed_content is None:
            raise ValueError("src must be a valid JSON string or file path.")
...
class RenderCtx(BaseModel):
    json_schema: str = Field(
        default=f"https://raw.githubusercontent.com/austinyu/cv-model/refs/heads/main/schemas/{_consts.CTX_SCHEMA_NAME}",
        alias="$schema",
    )
...
DEFAULT_RESUME = Resume(
    basics=Basics(
        ...
        url=AnyUrl("https://www.google.com"),
        ...
        profiles=[
            Basics.Profiles(
                network="GitHub",
                username="austinyu",
                url=AnyUrl("https://github.com/austinyu"),
            ),
            Basics.Profiles(
                network="LinkedIn",
                username="xinmiao-yu-619128174",
                url=AnyUrl("https://linkedin.com/in/xinmiao-yu-619128174"),
            ),
        ],
    ),
    work=[
        Work(
            ...
            url=AnyUrl("https://microsoft.com"),
    ...
    certificates=[
        ...
        Certificate(
            ...
            issuer="Google Cloud",
            url=AnyUrl("https://cloud.google.com/certification/data-engineer/"),
            date=datetime.date.fromisoformat("2023-05-01"),
        ),
        Certificate(
            name="Microsoft Certified: Azure Fundamentals",
            issuer="Microsoft",
            url=AnyUrl("https://learn.microsoft.com/en-us/certifications/azure-fundamentals/"),
            date=datetime.date.fromisoformat("2023-05-01"),
        ),
        Certificate(
            name="Certified Kubernetes Administrator (CKA)",
            issuer="Linux Foundation",
            url=AnyUrl("https://www.cncf.io/certification/cka/"),
            date=datetime.date.fromisoformat("2023-05-01"),
        ),
        Certificate(
            name="Certified Ethical Hacker (CEH)",
            issuer="",
            url=AnyUrl("https://www.eccouncil.org/programs/certified-ethical-hacker-ceh/"),
            date=datetime.date.fromisoformat("2023-05-01"),
        ),
    ],
    publications=[
        Publication(
            ...
            url=AnyUrl("https://arxiv.org/abs/quantum-computing"),
        ...
        Publication(
            ...
            releaseDate=datetime.date.fromisoformat("2023-05-01"),
            url=AnyUrl("https://oreilly.com/machine-learning-beginners"),
            summary="",
        ),
        Publication(
            ...
            releaseDate=datetime.date.fromisoformat("2023-05-01"),
            url=AnyUrl("https://packt.com/advanced-algorithms-python"),
        ...
        Publication(
            ...
            publisher="Springer",
            releaseDate=datetime.date.fromisoformat("2023-05-01"),
            url=AnyUrl("https://springer.com/data-science-handbook"),
    ...
    projects=[
        Project(
            ...
            endDate="Present",
            url=AnyUrl("https://hyperschedule.io"),
            roles=["Individual Contributor", "Maintainer"],
            entity="Claremont Colleges",
            type="application",
            source_code=AnyUrl("https://github.com/hyperschedule"),
        ),
        Project(
            ...
            url=AnyUrl("https://courses.claremont.edu"),
            roles=["Individual Contributor", "Maintainer"],
            entity="Claremont Colleges",
            type="application",
            source_code=AnyUrl("https://github.com/claremont-colleges"),
        ),
    ],
    custom_sections=[
        CustomSection(
    ...
    meta=Meta(
        canonical=AnyUrl("https://example.com/resume.json"),
        version="v1.0.0",
